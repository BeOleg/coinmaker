...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old CM_UppercaseCoinNamePullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/CM_UppercaseCoinNamedComparisonTool_jar/CM_UppercaseCoinNamedComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/CM_LowercaseCoinName/CM_LowercaseCoinName.git")
...
environ_default("BUILD_PATH", "/mnt/CM_LowercaseCoinName")
...
environ_default("GITHUB_REPO", "CM_LowercaseCoinName/CM_LowercaseCoinName")
