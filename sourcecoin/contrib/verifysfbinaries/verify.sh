...
WORKINGDIR="/tmp/CM_LowercaseCoinName"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/CM_LowercaseCoinName/CM_UppercaseCoinName/CM_LowercaseCoinName-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/CM_LowercaseCoinName/CM_UppercaseCoinName/"
VERSIONPREFIX="CM_LowercaseCoinName-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'CM_LowercaseCoinName-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[CM_LowercaseCoinName-]<version>-[rc[0-9]] (example: CM_LowercaseCoinName-0.7.1-rc1)"
   echo "wget output:"
