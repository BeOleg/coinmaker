...
std::string HelpMessageCli(bool mainProgram)
{
    ...
    strUsage += "  -rpcport=<port>        " + _("Connect to JSON-RPC on <port> (default: CM_RPCPort or testnet: 1CM_RPCPort)") + "\n";
    ...
    if(mainProgram)
    {
        ...
        strUsage += "\n" + _("SSL options: (see the CM_UppercaseCoinName Wiki for SSL setup instructions)") + "\n";
