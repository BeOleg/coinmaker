AC_DEFUN([CM_AllCapsCoinName_FIND_BDB48],[
  ...
  if test "x$bdbpath" = "xX"; then
    ...
    CM_AllCapsCoinName_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
    ...
    CM_AllCapsCoinName_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb48path}],db_cxx)
    bdbpath="${bdb48path}"
  fi
