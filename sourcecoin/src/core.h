...
#ifndef CM_AllCapsCoinName_CORE_H
#define CM_AllCapsCoinName_CORE_H
...
//DEVCOIN globals
static const int64_t initialSubsidy = CM_InitialSubsidy*COIN ;
...
{
//    return 0x0004;
    return CM_GetOurChainID;
}

/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = (int64_t)CM_MaxMoney * (int64_t)1000*COIN;
