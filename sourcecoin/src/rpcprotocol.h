...
#ifndef _CM_AllCapsCoinNameRPC_PROTOCOL_H_
#define _CM_AllCapsCoinNameRPC_PROTOCOL_H_ 1
...
// CM_UppercaseCoinName RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // CM_UppercaseCoinName is not connected
