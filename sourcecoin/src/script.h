...
#ifndef H_CM_AllCapsCoinName_SCRIPT
#define H_CM_AllCapsCoinName_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCM_UppercaseCoinNameAddress
 */
...
public:
    ...
    // Pre-version-0.6, CM_UppercaseCoinName always counted CHECKMULTISIGs
