    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString titleText       = tr("CM_UppercaseCoinName Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The CM_UppercaseCoinName Core developers"));
