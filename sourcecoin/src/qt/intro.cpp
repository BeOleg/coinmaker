...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/CM_LowercaseCoinName"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CM_UppercaseCoinName"),
     ...
     * override -datadir in the CM_LowercaseCoinName.conf file in the default data directory
     * (to be consistent with CM_LowercaseCoinNamed behavior)
     */
    if(dataDir != getDefaultDataDirectory())
