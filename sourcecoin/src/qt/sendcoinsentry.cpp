    ...
    model(0)
{
    ...
    // normal CM_LowercaseCoinName address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying CM_LowercaseCoinName address(es)
    ui->payTo_is->setFont(GUIUtil::CM_LowercaseCoinNameAddressFont());
}
