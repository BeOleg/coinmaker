...
#include "CM_LowercaseCoinName-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCM_UppercaseCoinNameURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CM_UppercaseCoinNameUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCM_UppercaseCoinNameURI(info));
}
