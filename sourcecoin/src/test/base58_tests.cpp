// Copyright (c) 2011-2014 The CM_UppercaseCoinName Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    std::vector<unsigned char> result;
    CCM_UppercaseCoinNameSecret secret;
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CCM_UppercaseCoinNameSecret::SetString tests isValid, whereas CCM_UppercaseCoinNameAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        else
        {
            ...
            CCM_UppercaseCoinNameAddress addrOut;
    ...
    CCM_UppercaseCoinNameAddress dummyAddr;
