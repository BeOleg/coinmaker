CM_UppercaseCoinName-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/CM_LowercaseCoinName/files/CM_UppercaseCoinName/CM_LowercaseCoinName-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CM_UppercaseCoinName
...
New/changed settings (command-line or CM_LowercaseCoinName.conf file)
--------------------------------------------------------
