Download URL: https://sourceforge.net/projects/CM_LowercaseCoinName/files/CM_UppercaseCoinName/CM_LowercaseCoinName-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CM_AllCapsCoinCode fee schedule (users still pay 0.01 CM_AllCapsCoinCode per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #CM_LowercaseCoinName00 - #CM_LowercaseCoinName99
