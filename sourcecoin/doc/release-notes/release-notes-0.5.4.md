CM_UppercaseCoinName version 0.5.4 is now available for download at:
http://sourceforge.net/projects/CM_LowercaseCoinName/files/CM_UppercaseCoinName/CM_LowercaseCoinName-0.5.4/
...
http://gitorious.org/CM_LowercaseCoinName/CM_LowercaseCoinNamed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CM_UppercaseCoinName-Qt notifications under Growl 1.3.
Increase required age of CM_UppercaseCoinName-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCM_UppercaseCoinName properly when installing CM_UppercaseCoinName-Qt over it. (Windows)
