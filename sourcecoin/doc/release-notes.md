CM_UppercaseCoinName Core version 0.9.2 is now available from:

  https://CM_LowercaseCoinName.org/bin/0.9.2/
...
installer (on Windows) or just copy over /Applications/CM_UppercaseCoinName-Qt (on Mac) or
CM_LowercaseCoinNamed/CM_LowercaseCoinName-qt (on Linux).
...
- Lower paytxfee warning threshold from 0.25 CM_AllCapsCoinCode to 0.01 CM_AllCapsCoinCode
...
- Fix "Start CM_LowercaseCoinName on system login"
