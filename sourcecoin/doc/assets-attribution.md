The following is a list of assets used in the CM_LowercaseCoinName source and their proper attribution.
...
* License: MIT
* Site: [https://CM_LowercaseCoinNametalk.org/index.php?topic=15276.0](https://CM_LowercaseCoinNametalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original CM_LowercaseCoinName logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/CM_LowercaseCoinName.icns, src/qt/res/src/CM_LowercaseCoinName.svg,
	src/qt/res/src/CM_LowercaseCoinName.ico, src/qt/res/src/CM_LowercaseCoinName.png,
	src/qt/res/src/CM_LowercaseCoinName_testnet.png, docs/CM_LowercaseCoinName_logo_doxygen.png,
