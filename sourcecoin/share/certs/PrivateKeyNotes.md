...
unlocked to sign the CM_UppercaseCoinName-Qt.app bundle.
...
allowing somebody to distribute a CM_UppercaseCoinName-Qt.app or CM_LowercaseCoinName-qt-setup.exe with a valid
...
that the CM_LowercaseCoinName-qt.exe file inside the installer had not been tampered with.
